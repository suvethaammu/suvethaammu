...
%>
  ...
  <br><br>
   <center><input type="submit" style="font-size: 15pt; height: 30px; width:120px;background-color: #e7e7e7; color: black;" value="SEARCH" id="search" onCLick="form.action='BookRoom1.jsp'"/>   </center>
