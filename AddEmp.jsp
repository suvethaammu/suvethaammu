...
<form action=" " onSubmit="return validate1();" method="post">
 ...
 <tr><td>Enter Employee Salary:</td><td><input type="text"  id="esal" name="esal"/></td><tr></tr><tr></tr><tr></tr>
   ...
   <center><input type="submit" style="font-size: 12pt; height: 30px; width:150px;background-color: #e7e7e7; color: black;"  value="ADD" id="login" onCLick="form.action='AdminInsert'"/></center><br><br>
    
	
  </form>
  
   	<%  String uname0=(String)session.getAttribute("uname");
	session.setAttribute("uname",uname0);
